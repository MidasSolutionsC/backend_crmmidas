...
class PromotionValidator{
  ...
  private function rulesCreate(){
    return [
      ...
      'nombre' => 'required|unique:promociones,nombre,tipo_servicios_id,' . $this->request->input('id'),
      // 'nombre' => 'required|unique:promociones,nombre,tipo_servicios_id,id,' . $this->request->input('id')
    ];
  }
