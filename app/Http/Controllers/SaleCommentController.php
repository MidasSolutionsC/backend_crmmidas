...
class SaleCommentController extends Controller{
  ...
  private $request;
  private $saleCommnetService;
  private $saleCommentValidator;

  public function __construct(Request $request, SaleCommentService $saleCommnetService, SaleCommentValidator $saleCommentValidator)
  {
    $this->request = $request;
    $this->saleCommnetService = $saleCommnetService;
    $this->saleCommentValidator = $saleCommentValidator;
  }

  public function listAll(){
    try{
      $result = $this->saleCommnetService->getAll();
  ...
  public function get($id){
    try{
      $result = $this->saleCommnetService->getById($id);
      $response = $this->response();
  ...
  public function create(){
    try{
      ...
      if($validator->fails()){
        ...
        $result = $this->saleCommnetService->create($this->request->all());
  ...
  public function update($id){
    try{
      ...
      if($validator->fails()){
        ...
        $result = $this->saleCommnetService->update($this->request->all(), $id);
        if($result != null){
  ...
  public function delete($id){
    try{
      $result = $this->saleCommnetService->delete($id);
      if($result){
  ...
  public function restore($id){
    try{
      $result = $this->saleCommnetService->restore($id);
      if($result){
